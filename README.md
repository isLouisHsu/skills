...
| Skill | 描述 | 位置 |
|-------|------|------|
| **project-docs-manager** | 以文档为中心的 AI 任务流程管理，参见[Project Docs Manager Skill：让 AI 自主驱动项目迭代的文档引擎](https://louishsu.xyz/2026/04/05/project_docs_manager_skill.html) | `skills/project-docs-manager/` |
